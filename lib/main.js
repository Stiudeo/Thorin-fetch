...
function createFetcher(config, name) {
  ...
  function doFetch(action, payload) {
    ...
    if ((typeof payload === 'undefined' ? 'undefined' : _typeof(payload)) === 'object' && payload && _typeof(payload.filter) === 'object' && payload.filter && _typeof(payload.payload) === 'object' && payload.payload) {
